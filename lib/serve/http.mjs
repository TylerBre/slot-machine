 ...
 */
export async function startServe({ port = SERVE_PORT, uiDir = null, spawnTarget, repos = {}, spawnTimeoutMs = undefined, streamIntervals = undefined, mirrorOptions = undefined } = {}) {
