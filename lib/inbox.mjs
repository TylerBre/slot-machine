...
// Cursor state lives in a SIBLING of the inbox dir, never inside it: waitForReports
// fs.watches the inbox dir, and a cursor write in there would wake every watcher on
// every non-destructive read.
function stateDir() {
