 ...
 */
export async function runCheck({ ack = false, json = false, world = null, now = null } = {}) {
...
export async function cmdWatch(argv) {
  ...
  if (values.hook)
    die('watch: --hook is wired by an agent delivery capability (sm doctor --fix installs it)');
