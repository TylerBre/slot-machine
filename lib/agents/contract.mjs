// The standard agent contract: the OK/ERR envelope every plugin op returns, the fixed err
// vocabulary the core reacts to, and the one guarded call path (callOp) through which the
// core invokes plugin ops. This is the only place plugin code is trusted.
