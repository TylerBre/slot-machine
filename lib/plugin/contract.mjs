// The standard plugin contract shared by every plugin system (agents, multiplexers): the OK/ERR
// envelope every plugin op returns, the fixed err vocabulary the core reacts to, and the one
// guarded call path (callOp) through which the core invokes plugin ops. This is the only place
